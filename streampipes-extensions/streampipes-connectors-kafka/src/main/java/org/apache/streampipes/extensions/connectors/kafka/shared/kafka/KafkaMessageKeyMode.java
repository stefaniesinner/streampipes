...
public enum KafkaMessageKeyMode {
  ...
  /**
   * Maps the internal id of the selected alternative to the corresponding mode.
   * Unknown ids are mapped to {@link #NONE} so that records are published without a key.
   *
   * @param internalId the internal id of the selected alternative
   * @return the message key mode
   */
  public static KafkaMessageKeyMode fromInternalId(String internalId) {
